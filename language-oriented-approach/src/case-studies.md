...
The TypeSpec code is about 10% the size of the generated OpenAPI. Not only do developers not have to create those extra 4,900 lines of OpenAPI, they also don't have to know how to write those extra lines of OpenAPI. Developers can write in a concise format and let their tooling doing all the hard work. The resulting OpenAPI document is one that automatically matched their guidelines, practices, and patterns. [Brian Terlson shares the same experience](https://mobile.twitter.com/bterlson/status/1572381666286665728) while using TypeScript:

Microsoft defines Cadl as "a language for describing cloud service APIs and generating other API description languages, client and service code, documentation, and other assets." Brian Terlson, who worked on Cadl, shares some of the reasoning for it and benefits it provides in a [Twitter thread](). Terlson states:
